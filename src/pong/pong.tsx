...
export class GameCanvas {
  ...
  draw() {
    ...
    // Draw score // un peu foireux
    context.font = '69px Krungthep'
  ...
  playerMoveKB(e: KeyboardEvent) {
    console.log(e)
  }

  computerMove() {
    this.oppenent.y += this.ball.speed.y * 0.77
  }
...
document.addEventListener('DOMContentLoaded', function () {
  let canvas = document.querySelector('canvas#pongCanvas') as HTMLCanvasElement
